                  ...
                  <div class="col-lg-6">
                    <div class="product_image_slider_container">
                      <div id="slider" class="flexslider">
                        <ul class="slides">
                          <li>
                            <img src="assets/images/product_image_1.jpg" />
                          </li>
                          <li>
                            <img src="assets/images/product_image_1.jpg" />
                          </li>
                      ...
                      <div class="carousel_container">
                        <div id="carousel" class="flexslider">
                          <ul class="slides">
                            ...
                            <li>
                              <div>
                                <img src="assets/images/product_7.jpg" />
                              </div>
                            </li>
                            <li>
                              <div>
                                <img src="assets/images/product_8.jpg" />
                              </div>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div class="col-lg-6 product_col">
                    <div class="product_info">
                      <div class="product_name">
                        Cool Clothing with Brown Stripes
                      </div>
                      ...
                      <div class="product_text">
                        <p>
                          ...
                          elit. Quisque nec consequat lorem. Maecenas elementum
                          at diam consequat bibendum. Mauris iaculis fringilla
                          ex, sit amet semper libero facilisis sit amet. Nunc ut
                          aliquet metus. Praesent pulvinar justo sed velit
                          tempus bibendum. Quisque dictum lorem id mi viverra,
                          in auctor justo laoreet. Nam at massa malesuada,
                          ullamcorper metus vel, consequat risus. Phasellus
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="box d-flex flex-row align-items-center justify-content-start">
                      <div class="mt-auto">
                        <div class="box_image">
                          <img src="assets/images/boxes_1.png" alt="" />
                        </div>
                      </div>
                  ...
                  <div class="col-lg-6 box_col">
                    <div class="box d-flex flex-row align-items-center justify-content-start">
                      <div class="mt-auto">
                        <div class="box_image">
                          <img src="assets/images/boxes_2.png" alt="" />
                        </div>
                      </div>
                      <div class="box_content">
                      ...
                      <div class="footer_about">
                        ...
                        <div class="footer_about_text">
                          <p>
                            ...
                            Suspendisse potenti. Fusce venenatis vel velit vel
                            euismod.
                          </p>
                        </div>
                      </div>
